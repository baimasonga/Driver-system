...
import '../dialogs/driver_form_dialog.dart';
      ...
      children: [
        Align(
          ...
          child: ElevatedButton.icon(
            onPressed: () => showDriverFormDialog(context),
                  ...
                  children: [
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _Metric(
                                ...
                                value: vehicle?.registrationNumber ?? 'None',
                    ...
                    PopupMenuButton<String>(
                      onSelected: (action) async {
                        if (action == 'edit') {
                          await showDriverFormDialog(context, d);
                        } else {
                          try {
                            await data.deleteDriver(
                              d.id,
